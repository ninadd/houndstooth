...
import { useDailySummary, type DailySummary } from "@/components/dashboard/daily-summary-context";
import { ProjectedPortfolioChart } from "@/components/dashboard/projected-portfolio-chart";
...
export function DailySummaryBanner() {
  const { summary, open, setOpen } = useDailySummary();
...
function SummaryContent({ summary }: { summary: DailySummary }) {
  ...
  return (
    <>
      ...
      <ProjectedPortfolioChart currentValue={d.tiles.investments} />
